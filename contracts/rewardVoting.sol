...
contract rewardVoting{
    ...
    // 构造函数
    constructor(string memory _projectName,uint256 _changeLines, string memory _target, uint _hoursAfter, string memory _types){
        ...
        types = _types;
        owner = msg.sender;
        emit CreateVoting(_projectName, _changeLines, _target, _hoursAfter, _types); // 触发合约级事件
    }
